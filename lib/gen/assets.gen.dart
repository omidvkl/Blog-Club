...
class $AssetsImgIconsGen {
  ...
  AssetGenImage get article =>
      const AssetGenImage('assets/img/icons/Article.png');

  /// File path: assets/img/icons/ArticleActive.png
  AssetGenImage get articleActive =>
      const AssetGenImage('assets/img/icons/ArticleActive.png');
